**During demo - Lightspeed prompts:**
```
1. What's the health status of demo-app namespace?
2. Why is payment-service crashing in demo-app?
3. Predict CPU usage for openshift-monitoring namespace
4. Detect anomalies in demo-app namespace
